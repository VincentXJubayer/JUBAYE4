...
•—» ${prefix} bot teach প্রশ্ন - উত্তর ✨
•—» ${prefix} bot delete প্রশ্ন - উত্তর ✨
•—» ${prefix} bot edit পুরাতনপ্রশ্ন - নতুনপ্রশ্ন ✨
•—» ${prefix} bot keyinfo প্রশ্ন ✨
•—» ${prefix} bot info ✨
...
module.exports.handleEvent = async function ({ event, api }) {
  ...
  if (messageReply && (messageReply.senderID === api.getCurrentUserID() || botMessageIds.has(messageReply.messageID))) {
    try {
      ...
      const replyMsg = res.data.success ? res.data.data.msg : "╭•┄┅═══❁🌺❁═══┅┄•╮\n🤖 আমি এখনো এই প্রশ্নের উত্তর জানি না, আমাকে Teach দিন\n╰•┄┅═══❁🌺❁═══┅┄•╯।";
